...
export const Errore = () => {
    return <div className="w-full m-auto ">
        <div div className="container mx-auto h-[350px] flex justify-center mt-40">
          <div className="w-[642px] h-[208px]  flex justify-center items-center ">
            ...
            <div className="pl-20">
                ...
                <p className="text-[18px] mt-5">We're sorry, This page is unknown or does not exist the page you are looking for</p>
                <div className="px-[10px] py-[4px] bg-[#4B6BFB] w-[130px] h-[40px] mt-3 text-center rounded-[6px]">
                       <button className="text-[14px] font-[500] text-center text-white"> Back to home</button>
                    </div>
            </div>
          </div>
        </div>
